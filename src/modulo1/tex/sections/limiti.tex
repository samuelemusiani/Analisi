...
Ne cosegue che graficamente l'asinto verticale si verifca quando la funzione sotto esame tende a $\pm \infty$ in un punto specifico (come in figura \ref{fig_asintotVer}):
