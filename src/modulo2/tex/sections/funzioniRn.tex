...
Le derivate direzionali sono un caso speciale della derivata direzionale: esse infatti si formano usando come vettore $v$ un vettore coordinato della base di $\mathbb{R}^n$. Se infatti scegliamo $v = (1, 0, \cdots, 0) = e_1$:
\begin{equation*}
...
\thm{
	\textbf{Teorema delle derivate parziali:} Data $f: \mathbb{R}^n \to \mathbb{R}$, $x_0 \in \mathbb{R}^n$ e $v \in \mathbb{R}^n$ con $\lVert v \rVert = 1$. Se $f$ è differenziale in $x_0$ allora vale:
	\begin{equation*}
