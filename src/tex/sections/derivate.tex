...
A livello grafico si può vedere questo teorema come una sorta di passaggio obbligato se si vuole andare da un punto ad un altro della stessa funzione. Cioè se ho una funzione come in figura \ref{TeoremaRolle} e volessi anadare dal punto più a sinistra al punto più a destra sarei costretto a salire e poi scendere. Nell'istante estatto in cui smetto di salire e devo inziare a scendere sono in un punto "piatto": ed è proprio qui che la derivata si annulla.
...
È fondamentale che la funzione sia derivabile in $]a,b[$ perché se non lo fosse il teorema non si applicherebbe. Per sempio in figura \ref{} e rappresentata la seguente funzione:
\begin{equation*}
	f(x) =
	\begin{cases*}
