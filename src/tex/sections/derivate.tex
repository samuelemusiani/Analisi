...
%Fare alcuni esempi di calcolo della derivata

%Aggiungere regole di derivazione in una sezione a parte.

%Fare tutta la parte sul valore assoluto che non è derivabile ma x|X| lo è.

%Algebra delle derivate

%Derivate funzioni elementari e loro inverse (goniometriche pure!!)
