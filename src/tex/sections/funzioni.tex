...
\pf{
	...
	\end{equation*}
	Utilizzando la proprietà di completezza di $\mathbb{R}$ (Sezione: \ref{completezzaR}) definiamo un insieme $A$ tale che:
	\begin{equation*}
...
\begin{figure}
	\begin{center}
		...
		\draw[very thin, fill] (1,1) circle (0.4pt) node[left] {$Q(1, y_q)$}; %Punto
