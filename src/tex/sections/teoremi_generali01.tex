...
\end{tikzpicture}
  ...
  \label{WeierstrassIntervalloAperto}
\end{figure}

\begin{figure}[h]
\centering
\begin{tikzpicture}
\begin{axis}[xmax = 10, xmin = -0.5, ymax = 1.5, ymin = -0.5,
             axis lines=middle, xlabel=$x$, ylabel=$y$,
             xtick={2, 4, 6, 8},
             ytick={0.5, 1},
...
\end{tikzpicture}
  ...
  \label{WeierstrassIntervalloIllimitato}
\end{figure}
...
\pf{
	\begin{center}
		\includegraphics[width=250px]{../img/WeierstrassCostruzione.png}
	\end{center}
