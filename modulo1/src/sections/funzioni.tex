...
\begin{equation*}
	\binom{n}{m} = \dfrac{n!}{(n-m)!m!} = \dfrac{n (n - 1) (n -2) \cdots (n - m + 1)}{m!}
\end{equation*}
...
\begin{equation*}
	\binom{\alpha}{m} = 
		...
		\dfrac{\alpha (\alpha - 1) (\alpha -2) \cdots (\alpha - m + 1)}{m!} &\mathrm{se}\quad \alpha \geq 1\\
		\end{cases}
\end{equation*}
...
\mlem{
	...
	\begin{enumerate}[label=\Alph*)]
	    ...
	    \item $x^2 > y \implies \exists \epsilon > 0: (x-\epsilon)^2 > y$ \quad con $x > 0$
	\end{enumerate}
    Dimostrazione: assumiamo come ipotesi generale che: $\forall x, y \in \mathbb{R}: x, y \geq 0$.
    ...
    \begin{enumerate}[label=(\Alph*)]
        \item Vogliamo dimostrare che 
            ...
            \begin{align*}
                ...
                &(x+y)(x-y) \leq 0
            \end{align*}
            Ovviamente essendo $x, y \geq 0 \implies x+y \geq 0$, l'unico modo per cui l'espressine sia negativa è che il secondo termine sia negativo:
            \begin{gather*}
                x-y \leq 0\\
                x \leq y
            \end{gather*}
        ...
        \item Vogliamo dimostrare che:
            ...
            \begin{gather*}
                ...
                = x^2 + \epsilon(2x + 1)
            \end{gather*}
            È possibile ora scegliere $\epsilon$ in modo da soddisfare $x^2 + \epsilon(2x + 1) < y$?
            \begin{gather*}
                x^2 + \epsilon(2x + 1) < y\\
                \epsilon(2x + 1) < y - x^2\\
        ...
        \item Vogliamo dimostrare, sotto l'ipotesi aggiuntiva $x > 0$, che:
            ...
            \end{align*}
            Per ipotesi $x > 0$ e $x^2-y > 0$. È quindi possibile scegliere un $\epsilon$ affinché la tesi si verifichi:
            \begin{equation*}
