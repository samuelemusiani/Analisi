...
\pf{
	...
	\begin{align*}
        ...
        =\\[10pt]
		= &\lim_{h \to 0} \cos(x) \cdot \dfrac{\cos(h) - 1}{h} - \sin(x) \cdot 
        \dfrac{\sin(h)}{h}
	\end{align*}
	Usando qualche limite notevole visto in precedenza (Sezione 
    \ref{sec_limitiNotevoli}):
...
il teorema non si applicherebbe. Per esempio in figura \ref{fig_esempioRolle} è 
...
\pf{
	...
	\begin{equation*}
		\forall (x_n)_n \subseteq I, \, x_n > x_0 \;\; \forall n \; \text{tale 
