...
Per capire quanto segue è necessario prima guardare la sezioni sui limiti delle successioni (\ref{sec_lim_successioni}).
\dfn{
...
\begin{enumerate}
    \item $\mathbf{L = + \infty}$
        ...
        cioè
        \begin{equation*}
            \forall K > 0, \exists \bar{n} \in \mathbb{N} : \forall n \geq \overline{n} : a_n > K
        \end{equation*}
        ...
        \begin{itemize}
            ...
            \item Ne consegue che K non è un maggiorante $\implies \exists a_\bar{n} \in A : a_{\bar{n}} > K$
    ...
    Ci riduciamo a provare che 
        ...
        cioè
        \begin{align*}
            \forall \epsilon > 0, \exists \bar{n} \in \mathbb{N} : \forall n \geq \overline{n} : |a_n& - L| < \epsilon\\
            &\Big\Updownarrow\\
