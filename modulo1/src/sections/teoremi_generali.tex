...
\begin{equation*}
    \forall n, a_n < 0 \implies \lim _{n \to +\infty} a_n = l \in R \; \land \; l \leq 0
\end{equation*}
...
\begin{equation*}
    \forall \epsilon > 0, \exists \overline{n} \in \mathbb{N} : \forall n \geq \overline{n} \implies |a_n - l| < \epsilon
\end{equation*}
Se espandiamo $|a_n - l| < \epsilon$ ci troviamo con:
\begin{equation*}
    l - \epsilon < a_n < l + \epsilon
\end{equation*}
Ed essendo che questa condizione deve valere $\forall \epsilon > 0$, scegliamo $\epsilon = \dfrac{l}{2}$. Quindi deve valere che:
\begin{equation*}
...
\end{equation*}
\begin{equation*}
    \exists x_1 \in [a,b]: f(x) \geq f(x_1) = \vcentcolon m \quad \forall x \in [a,b]
\end{equation*}
E quindi:
\begin{equation*}
