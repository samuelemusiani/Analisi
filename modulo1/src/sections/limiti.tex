...
\dfn{
    ...
    \begin{equation*}
        \lim_{n \to +\infty} a_n = L \qquad \text{oppure} \qquad (a)_n \xrightarrow[n \to +\infty]{} L
    \end{equation*}
    \qquad se
    \begin{equation*}
...
\dfn{
    ...
    \begin{itemize}
        \item \begin{equation*}
                \lim_{n \to +\infty} a_n = +\infty \qquad \text{oppure} \qquad (a)_n \xrightarrow[n \to +\infty]{} +\infty
            \end{equation*}
            \qquad se
            \begin{equation*}
